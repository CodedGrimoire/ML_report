...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig12_per_class_recall.png}
    \caption{Safe- and unsafe-class recall for all models at the balanced operating point.}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig03_roc_test.png}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig04_pr_curves.png}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=\linewidth]{figures/fig11_operating_modes.png}
    \caption{Ensemble performance at the balanced, high-recall, and max-recall operating points.}
...
\begin{figure}[!t]
    ...
    \caption{Train, validation, and test error for all nine models after retraining.}
...
\begin{figure}[!t]
    ...
    \caption{Train-to-test generalization gap for all nine models.}
